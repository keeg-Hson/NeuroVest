...
@pytest.mark.xfail(using_pyarrow_string_dtype(), reason="share memory doesn't work for arrow")
...
def test_reindex_datetimeindexes_tz_naive_and_aware():
    ...
    msg = r"Cannot compare dtypes datetime64\[ns, America/Chicago\] and datetime64\[ns\]"
