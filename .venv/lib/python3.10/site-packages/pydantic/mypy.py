...
class PydanticModelField:
    ...
    def to_argument(
        ...
        type_annotation = (
            self.expand_type(current_info, api) if typed else AnyType(TypeOfAny.explicit)
        )
        return Argument(
            variable=variable,
    ...
    def to_var(
        self, current_info: TypeInfo, api: SemanticAnalyzerPluginInterface, use_alias: bool
    ) -> Var:
