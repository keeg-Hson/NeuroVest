...
class KeyValue(object):
    ...
    def __init__(
        self, key_field=None, value_field=None, ordered=False, database=None, table_name="keyvalue"
    ):
        ...
        support_on_conflict = isinstance(self._database, PostgresqlDatabase) or (
            isinstance(self._database, SqliteDatabase) and self._database.server_version >= (3, 24)
        )
