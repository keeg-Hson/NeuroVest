...
try:
    ...
    TRANSACTION_STATUS_IDLE = TRANSACTION_STATUS_INERROR = TRANSACTION_STATUS_UNKNOWN = None
try:
...
class PooledDatabase(object):
    ...
    def init(
        self, database, max_connections=None, stale_timeout=None, timeout=None, **connect_kwargs
    ):
    ...
    def _close(self, conn, close_conn=False):
        ...
        if close_conn:
            ...
            if self._stale_timeout and self._is_stale(pool_conn.timestamp):
                ...
                heapq.heappush(self._connections, (pool_conn.timestamp, _sentinel(), conn))
            else:
