...
class YfData(metaclass=SingletonMeta):
    ...
    def post(self, url, body, params=None, timeout=30):
        return self._make_request(
            url, request_method=self._session.post, body=body, params=params, timeout=timeout
        )
    ...
    def _is_this_consent_url(self, response_url: str) -> bool:
        ...
        """
        try:
            return urlsplit(response_url).hostname and urlsplit(response_url).hostname.endswith(
                "consent.yahoo.com"
            )
        except Exception:
            return False
