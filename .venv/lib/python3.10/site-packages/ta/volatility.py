...
def average_true_range(high, low, close, window=14, fillna=False):
    ...
    Returns:
        pandas.Series: New feature generated.
    """
    indicator = AverageTrueRange(high=high, low=low, close=close, window=window, fillna=fillna)
...
def bollinger_hband(close, window=20, window_dev=2, fillna=False):
    ...
    Returns:
        pandas.Series: New feature generated.
    """
    indicator = BollingerBands(close=close, window=window, window_dev=window_dev, fillna=fillna)
