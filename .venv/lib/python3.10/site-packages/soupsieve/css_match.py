...
class _DocumentNav:
    ...
    def is_special_string(obj: bs4.element.PageElement | None) -> bool:
        """Is special string."""
        return isinstance(
            obj, (bs4.Comment, bs4.Declaration, bs4.CData, bs4.ProcessingInstruction, bs4.Doctype)
        )
...
class SoupSieve(ct.Immutable):
    ...
    def __init__(
        ...
        super().__init__(
            pattern=pattern, selectors=selectors, namespaces=namespaces, custom=custom, flags=flags
        )
